...
ros::Publisher pub_fail_signal, pub_initialize_signal;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_fail_signal = n.advertise<std_msgs::Empty>("fail", 1000);
    pub_initialize_signal = n.advertise<sensor_msgs::PointCloud>("initialize_success", 1000);
